...
# loading the models
diabetes_model = joblib.load(get_path("models", "diabetes_model.sav"))
heart_model = joblib.load(get_path("models", "heart_disease_model.sav"))
parkinson_model = joblib.load(get_path("models", "parkinsons_model.sav"))
# Load the lung cancer prediction model
lung_cancer_model = joblib.load(get_path("models", "lung_cancer_model.sav"))

# Load the pre-trained model
breast_cancer_model = joblib.load(get_path("models", "breast_cancer.sav"))

# Load the pre-trained model
chronic_disease_model = joblib.load(get_path("models", "chronic_model.sav"))

# Load the hepatitis prediction model
hepatitis_model = joblib.load(get_path("models", "hepititisc_model.sav"))


liver_model = joblib.load(get_path("models", "liver_model.sav"))
lung_cancer_model = joblib.load(get_path("models", "lung_cancer_model.sav"))
...
if selected == 'Diabetes Prediction':  # pagetitle
    ...
    image = Image.open(get_path('d3.jpg'))
    ...
    if st.button("Diabetes test result"):
        ...
        if diabetes_prediction[0] == 1:
            ...
            image = Image.open(get_path('positive.jpg'))
            st.image(image, caption='')
        else:
            diabetes_dig = 'Congratulation,You are not diabetic'
            image = Image.open(get_path('negative.jpg'))
            st.image(image, caption='')
...
if selected == 'Heart disease Prediction':
    ...
    image = Image.open(get_path('heart2.jpg'))
...
if selected == 'Parkison Prediction':
    ...
    image = Image.open(get_path('p1.jpg'))
...
if selected == 'Lung Cancer Prediction':
    ...
    image = Image.open(get_path('h.png'))
...
if selected == 'Liver prediction':  # pagetitle
    ...
    image = Image.open(get_path('liver.jpg'))
...
if selected == 'Jaundice prediction':  # pagetitle
    ...
    image = Image.open(get_path('j.jpg'))
